...
void protobuf_AssignDesc_unittest_5fimport_5fpublic_2eproto() {
  protobuf_AddDesc_unittest_5fimport_5fpublic_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_unittest_5fimport_5fpublic_2eproto);
}
...
void protobuf_ShutdownFile_unittest_5fimport_5fpublic_2eproto() {
  delete PublicImportMessage::default_instance_;
  delete PublicImportMessage_reflection_;
}

void protobuf_AddDesc_unittest_5fimport_5fpublic_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\034unittest_import_public.proto\022\030protobuf"
    "_unittest_import\" \n\023PublicImportMessage\022"
    "\t\n\001e\030\001 \001(\005B\032\n\030com.google.protobuf.test", 118);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "unittest_import_public.proto", &protobuf_RegisterTypes);
  PublicImportMessage::default_instance_ = new PublicImportMessage();
  PublicImportMessage::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_unittest_5fimport_5fpublic_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_unittest_5fimport_5fpublic_2eproto {
  StaticDescriptorInitializer_unittest_5fimport_5fpublic_2eproto() {
    protobuf_AddDesc_unittest_5fimport_5fpublic_2eproto();
  }
} static_descriptor_initializer_unittest_5fimport_5fpublic_2eproto_;
...
const PublicImportMessage& PublicImportMessage::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_unittest_5fimport_5fpublic_2eproto();
